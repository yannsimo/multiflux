...
namespace PricingLibrary.Services
{
    ...
    {
        /// <summary>
        /// D�s�rialise le contenu d'un fichier JSON dans un objet TestParameters.
        /// </summary>
        ...
        //je vais t'envoyer la composition de la classe ParameterInfo.JsonUtils.JsonIO peut tu me dise si �a peut aider


        public static void SerializeOutputDataList(List<OutputData> outputDataList, string filePath)
        {
            if (outputDataList == null)
                throw new ArgumentNullException(nameof(outputDataList), "La liste OutputData ne peut pas �tre nulle.");
